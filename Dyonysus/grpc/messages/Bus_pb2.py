...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\tBus.proto\x12\x03\x62us\"(\n\nBusRequest\x12\n\n\x02id\x18\x01 \x02(\x05\x12\x0e\n\x06number\x18\x02 \x02(\x05\"`\n\x0b\x42usResponse\x12\n\n\x02id\x18\x01 \x02(\x05\x12\x0e\n\x06number\x18\x02 \x02(\x05\x12\x17\n\x0fpeople_capacity\x18\x03 \x02(\x05\x12\x1c\n\x14\x61verage_people_count\x18\x04 \x02(\x02\x32:\n\x08\x44yonysus\x12.\n\x07Service\x12\x0f.bus.BusRequest\x1a\x10.bus.BusResponse\"\x00'
)
...
_DYONYSUS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Service',
    full_name='bus.Dyonysus.Service',
    index=0,
